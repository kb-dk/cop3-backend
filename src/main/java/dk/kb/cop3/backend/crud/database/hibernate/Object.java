...
public class Object  implements java.io.Serializable {
    ...
    public Object(String id, Type type, Edition edition, String mods, String lastModified, char deleted, String lastModifiedBy, BigDecimal objVersion, BigDecimal randomNumber, BigDecimal interestingess) {
        this.id = id;
        this.type = type;
